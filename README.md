...
This the Rails 3.1 and Spree 0.70 compatible version (using Deface and Railties). This also uses Resque rather than Delayed_Job.
...
GOTCHAS
===========
If you're using the Solr plugin, please MAKE SURE Solr IS RUNNING, or else the import task will fail
